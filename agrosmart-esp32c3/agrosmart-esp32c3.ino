...
// Identidad del nodo. Estos son los datos del nodo LOCAL (empresa "Monterey",
// Terreno 1) ya registrado en la base de datos de este backend de pruebas.
// const char* NODO_UUID   = "3830c00c-77f7-4a56-b9b0-719b5ca11ee3";  // nodo de la nube
// const char* NODO_IDENT  = "nodo_53eaf1f3";
// const char* NODO_SECRET = "5975fe4d571c7451452f122312ea5e1ba41248f48b895a80";
// const char* PARCELA_ID  = "db1b523a-fe82-4b1e-94db-075c9a4e4eab";
const char* NODO_UUID     = "8daae064-741a-4f07-997b-b869925cfdff";
...
// CALIBRACION: Valor ADC cuando el sensor esta en aire (seco)
const int HUM_SECO = 3230;
// Valor ADC cuando el sensor esta en agua (humedo)
const int HUM_HUMEDO = 1815;
...
// esperando el siguiente ciclo (NORMAL), publica una cuenta regresiva 5..1
...
int segundosEvaluacion = 5;

String topicTelemetria, topicEstado, topicComandos, topicConfig, topicRiegoStatus;

// Polaridad del rele: este modulo resulto ser activo en ALTO (HIGH enciende
// la bomba), al reves del anterior. Si vuelves a cambiar de modulo y la
// bomba queda invertida otra vez, cambia solo esta constante.
...
void setup() {
  Serial.begin(115200);
  delay(100);
  Serial.println("\n=== AgroSmart ESP32-C3 v3 (Autonomo) ===");
