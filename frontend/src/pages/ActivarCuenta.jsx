...
export default function ActivarCuenta({ modo = 'recuperar' }) {
  ...
  return (
    <AuthLayout titulo={modo === 'activar' ? 'Activa tu cuenta' : 'Restablece tu contraseña'} subtitulo={subtitulo}>
      {verificando ? (
        ...
        <form onSubmit={guardar}>
          ...
          <Campo label="Nueva contraseña" id="passNueva">
          ...
          <Campo label="Confirmar contraseña" id="passConf">
            <CampoConIcono icono={Lock}>
              <CampoPassword
                id="passConf"
